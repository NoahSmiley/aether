...
final class XtreamAPI {
    ...
    private var baseURL: String {
        UserDefaults.standard.string(forKey: "xtreamBaseURL") ?? "http://line.trxdnscloud.ru"
    }

    private var username: String {
        UserDefaults.standard.string(forKey: "xtreamUsername") ?? "914f80594b"
    }

    private var password: String {
        UserDefaults.standard.string(forKey: "xtreamPassword") ?? "32d6ec5d6f"
    }
    ...
    private func request<T: Decodable>(_ url: URL) async throws -> T {
        ...
        #if DEBUG
        print("[XtreamAPI] GET \(url.absoluteString) -> \(httpResponse.statusCode)")
        #endif
